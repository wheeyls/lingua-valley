 ...
 * — though not every campaign's objectives lean on every field; see each
 * Lesson's own comments). Pueblo del Ayer teaches the SIMPLE PAST:
 * understanding someone recount their day, retelling it, and recounting
 * your own. Fiesta de Daphne teaches descriptive clue vocabulary (wet/dry,
 * play area, food, animals) used to deduce where the Silly Goose is hiding.
 */
...
export const A2_FIESTA_DAPHNE: Lesson = {
  id: "fiesta-daphne",
  level: "A2",
  title: "El ganso travieso — find the Silly Goose",
  canDo:
    "understand simple clues about a place (wet or dry, a place to play, " +
    "food nearby, animals nearby) and use them to guess where something " +
    "is, using 'creo que está en...'",
  vocab: [
    { es: "mojado / seco", en: "wet / dry" },
    { es: "un lugar para jugar", en: "a place to play" },
    { es: "hay comida", en: "there's food" },
    { es: "hay animales", en: "there are animals" },
    { es: "creo que está en…", en: "I think it's at/in…" },
    { es: "¿dónde está…?", en: "where is…?" },
    { es: "las llaves", en: "the keys" },
    { es: "el ganso", en: "the goose" },
    { es: "escondido / escondida", en: "hidden" },
    { es: "busca", en: "look for / search" },
    { es: "el abuelo / la abuela", en: "grandfather / grandmother" },
    { es: "el tío / la tía", en: "uncle / aunt" },
  ],
  // No storyTheme/retellTheme/reviewTheme — this campaign's objectives
  // (GooseStakes/GooseClue/FindTheGoose/GooseEncounter) build their own
  // theme strings directly from gooseLocationForDay(), not from the lesson.
};
